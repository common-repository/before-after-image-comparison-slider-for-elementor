...
= 1.6.1 (03-04-23) =
# Fix Double Slash issue on assets include url
# Make compatible with Latest WordPress

= 1.6.0 (04-08-22) =
# Fix `Elementor\Widgets_Manager::register_widget_type` is soft deprecated since 3.5.0
# Fix `elementor/widgets/widgets_registered` is soft deprecated since 3.5.0 
# Fix Deprecated: _register_controls is deprecated since version 3.1.0! 

= 1.5.0 (08-14-21) =
# Make Compatible with WordPress 5.8
# Make Compatible with the latest Elementor 3.3.1

= 1.4.9 (06-22-21) =
# Fix Conflict with Post SMTP Plugin
# Tested with Latest Elementor Version

= 1.4.8 (01-08-21) =
# Fix Plugin Broke Multisite Issue
# Make Compatible with Multisite
